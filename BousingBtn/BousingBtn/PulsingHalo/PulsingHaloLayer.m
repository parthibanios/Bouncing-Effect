...
- (void)_setupDefaults {
    ...
    self.backgroundColor = [UIColorFromRGB(0xa6bb) CGColor];//[[UIColor colorWithRed:0.000 green:0.455 blue:0.756 alpha:0.45] CGColor];
}
...
- (void)_setupAnimationGroup {
    ...
    opacityAnimation.values = @[@(fromValueForAlpha), @(fromValueForAlpha * 2), @0];
